...
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name FatalSecKey.pem --security-groups roman_numbers_sec_grp --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh

file:///Users/ODG/Desktop/git_dir/serdar-cw/porfolio_lesson_plan/week_6/CLI_solution/userdata.sh
...
- To delete instances:
aws ec2 terminate-instances --instance-ids i-02bb50d66046a9f14
